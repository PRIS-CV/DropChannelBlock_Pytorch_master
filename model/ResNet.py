...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, cdb_flag, num_classes=1000, zero_init_residual=False,
...
def _resnet(arch, block, layers, pretrained, cdb_flag, progress, **kwargs):
    model = ResNet(block, layers, cdb_flag, **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, cdb_flag="none", progress=True, **kwargs):
    ...
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, cdb_flag, progress,
                   **kwargs)